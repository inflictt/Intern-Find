...
const internshipData = [
    {
        ...
        description: "STEP (Student Training in Engineering Program) is a developmental opportunity for first and second-year undergraduate students with a passion for computer science. You will work on a software project alongside other STEP interns and full-time Googlers, receiving mentorship and training.",
        eligibility: "• Bachelor's student in Computer Science or related field.<br>• Graduating in 2027 or 2028 (1st or 2nd year students only).<br>• Experience in C, C++, Java, JavaScript, or Python.",
    ...
    },
    {
        ...
        type: "Internship",
        postedDate: "2024-12-28",
        description: "Explore is a 12-week summer internship program specifically designed for first and second-year college students. It provides the opportunity to experience different roles in software development and program management.",
        eligibility: "• First or Second year student enrolled in a Bachelor's degree.<br>• majoring in CS, EE, or related field.<br>• Strong interest in software engineering and program management.",
    ...
    },
    {
        ...
        type: "Internship",
        postedDate: "2024-12-28",
        description: "Meta University is a 10-week immersive program designed to provide hands-on experience in engineering. Includes coding bootcamp and project phase.",
        eligibility: "• 1st or 2nd year students at an accredited university.<br>• Candidates from historically underrepresented groups are encouraged to apply.",
